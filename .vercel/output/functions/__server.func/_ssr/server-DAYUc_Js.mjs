...
import { t as resolveManifestAssetLink, k as rootRouteId, w as defineHandlerCallback, x as getNormalizedURL, y as getOrigin, z as attachRouterServerSsrUtils, A as createSerializationAdapter, C as createRawStreamRPCPlugin, i as invariant, g as isNotFound, m as isRedirect, D as isResolvedRedirect, E as getStylesheetHref, F as mergeHeaders, G as executeRewriteInput, H as defaultSerovalPlugins, I as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DlHaEdVT.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BKi6DlVp.mjs").then((n) => n.r),
    import("./start-Cj2FIoQg.mjs"),
