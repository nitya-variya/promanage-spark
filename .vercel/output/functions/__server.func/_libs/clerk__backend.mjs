import { b as buildErrorThrower, x as ClerkError, y as isomorphicAtob, k as deprecated, z as ClerkAPIResponseError, A as getCookieSuffix, B as isDevelopmentFromSecretKey, D as match, E as getAutoProxyUrlFromEnvironment, F as isLegacyDevAccountPortalOrigin, G as isCurrentDevAccountPortalOrigin, H as buildAccountsBaseUrl, I as parsePublishableKey, J as getSuffixedCookieName, K as retry, L as isClerkAPIResponseError, _ as __experimental_JWTPayloadToAuthObjectProperties, j as createCheckAuthorization, M as parseError, T as TelemetryCollector } from "./clerk__shared.mjs";
...
var API_VERSION = "v1";
var USER_AGENT = `${"@clerk/backend"}@${"3.4.11"}`;
