import { b as buildErrorThrower, u as useAssertWrappedByClerkProvider$1, a as useClerkInstanceContext, w as without, i as isDeeplyEqual, l as logErrorInDevMode, c as usePortalRoot, g as getEnvVariable, e as eventMethodCalled, d as useInitialStateContext, f as deriveState, h as inBrowser, C as ClerkRuntimeError, j as createCheckAuthorization, r as resolveAuthState, k as deprecated, m as isVersionCompatible, n as ClerkContextProvider, o as createClerkEventBus, p as clerkEvents, q as handleValueOrFn, s as loadClerkJSScript, t as loadClerkUIScript, v as setClerkJSLoadingErrorPackageName } from "./clerk__shared.mjs";
import { R as React__default, r as reactExports, b as jsxRuntime, c as React } from "./react.mjs";
import { r as reactDomExports, b as reactDomClient, c as reactDom } from "./react-dom.mjs";
...
var assertSingleChild = (children) => (name) => {
  try {
    ...
    if (childArray.length === 1 && React__default.isValidElement(childArray[0])) {
      return childArray[0];
    }
...
var normalizeWithDefaultValue = (children, defaultText) => {
  ...
  if (typeof children === "string") {
    children = /* @__PURE__ */ React__default.createElement("button", null, children);
  }
  return children;
};
...
var isThatComponent = (v, component) => {
  return !!v && React__default.isValidElement(v) && (v == null ? void 0 : v.type) === component;
};
...
var useCustomMenuItems = ({
  ...
  React__default.Children.forEach(children, (child) => {
    ...
    const { props } = child;
    React__default.Children.forEach(props.children, (child2) => {
...
var ClerkHostRenderer = class extends React__default.PureComponent {
  constructor() {
    super(...arguments);
    this.rootRef = React__default.createRef();
  }
  ...
  render() {
    ...
    return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, !hideRootHtmlElement && /* @__PURE__ */ React__default.createElement("div", { ...rootAttributes }), this.props.children);
  }
};
...
var SignIn = withClerk(
  ({ clerk, component, fallback, ...props }) => {
    ...
    return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, shouldShowFallback && fallback, clerk.loaded && /* @__PURE__ */ React__default.createElement(
      ClerkHostRenderer,
      {
        component,
...
var _UserProfile = withClerk(
  ({
    ...
    return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, shouldShowFallback && fallback, /* @__PURE__ */ React__default.createElement(
      ClerkHostRenderer,
      {
        component,
      ...
      /* @__PURE__ */ React__default.createElement(CustomPortalsRenderer, { customPagesPortals })
    ));
  },
...
var _UserButton = withClerk(
  ({
    ...
    return /* @__PURE__ */ React__default.createElement(UserButtonContext.Provider, { value: passableProps }, shouldShowFallback && fallback, clerk.loaded && /* @__PURE__ */ React__default.createElement(
      ClerkHostRenderer,
      {
        component,
        ...passableProps,
      ...
      /* @__PURE__ */ React__default.createElement(CustomPortalsRenderer, { ...portalProps })
    ));
  },
...
function UserButtonOutlet(outletProps) {
  ...
  return /* @__PURE__ */ React__default.createElement(ClerkHostRenderer, { ...portalProps });
}
...
var _OrganizationSwitcher = withClerk(
  ({
    ...
    return /* @__PURE__ */ React__default.createElement(OrganizationSwitcherContext.Provider, { value: passableProps }, /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, shouldShowFallback && fallback, clerk.loaded && /* @__PURE__ */ React__default.createElement(
      ClerkHostRenderer,
      {
        ...passableProps,
        hideRootHtmlElement: !!props.__experimental_asProvider
...
function useAuthBase() {
  ...
  const state = reactExports.useSyncExternalStore(
    reactExports.useCallback((callback) => clerk.addListener(callback, { skipInitialEmit: true }), [clerk]),
...
function computeReactVersionCompatibility() {
  try {
    return isVersionCompatible(React__default.version, define_CLERK_UI_SUPPORTED_REACT_BOUNDS_default);
  } catch {
    return false;
  }
}
...
var _IsomorphicClerk = class _IsomorphicClerk2 {
  constructor(options) {
    ...
    this.buildSignInUrl = (opts) => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildSignInUrl(opts)) || "";
      };
    ...
    this.buildSignUpUrl = (opts) => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildSignUpUrl(opts)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterSignInUrl = (...args) => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildAfterSignInUrl(...args)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterSignUpUrl = (...args) => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildAfterSignUpUrl(...args)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterSignOutUrl = () => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildAfterSignOutUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildNewSubscriptionRedirectUrl = () => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildNewSubscriptionRedirectUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterMultiSessionSingleSignOutUrl = () => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildAfterMultiSessionSingleSignOutUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildUserProfileUrl = () => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildUserProfileUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildCreateOrganizationUrl = () => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildCreateOrganizationUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildOrganizationProfileUrl = () => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildOrganizationProfileUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildWaitlistUrl = () => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildWaitlistUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildTasksUrl = () => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildTasksUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildUrlWithAuth = (to) => {
      const callback = () => {
        var _a22;
        return ((_a22 = this.clerkjs) == null ? void 0 : _a22.buildUrlWithAuth(to)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.handleUnauthenticated = async () => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.handleUnauthenticated();
      };
      if (this.clerkjs && this.loaded) {
        void callback();
      } else {
    ...
    this.on = (...args) => {
      var _a22;
      if ((_a22 = this.clerkjs) == null ? void 0 : _a22.on) {
    ...
    this.off = (...args) => {
      var _a22;
      if ((_a22 = this.clerkjs) == null ? void 0 : _a22.off) {
    ...
    this.replayInterceptedInvocations = (clerkjs) => {
      ...
      (_a22 = __privateGet(this, _eventBus).internal.retrieveListeners("status")) == null ? void 0 : _a22.forEach((listener) => {
    ...
    this.__experimental_prefetchOrganizationSwitcher = () => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.__experimental_prefetchOrganizationSwitcher();
      };
      if (this.clerkjs && this.loaded) {
        void callback();
      } else {
      ...
      if (this.clerkjs) {
        ...
        const unsubscribe = () => {
          ...
          if (listenerExtras == null ? void 0 : listenerExtras.handlers) {
            (_b = listenerExtras == null ? void 0 : (_a22 = listenerExtras.handlers).nativeUnsubscribe) == null ? void 0 : _b.call(_a22);
    ...
    this.navigate = (to) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.navigate(to);
      };
      if (this.clerkjs && this.loaded) {
        void callback();
      } else {
    ...
    this.redirectWithAuth = async (...args) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.redirectWithAuth(...args);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToSignIn = async (opts) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.redirectToSignIn(opts);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToSignUp = async (opts) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.redirectToSignUp(opts);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToUserProfile = async () => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.redirectToUserProfile();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToAfterSignUp = () => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.redirectToAfterSignUp();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToAfterSignIn = () => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.redirectToAfterSignIn();
      };
      if (this.clerkjs && this.loaded) {
        callback();
      } else {
    ...
    this.redirectToAfterSignOut = () => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.redirectToAfterSignOut();
      };
      if (this.clerkjs && this.loaded) {
        callback();
      } else {
    ...
    this.redirectToOrganizationProfile = async () => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.redirectToOrganizationProfile();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToCreateOrganization = async () => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.redirectToCreateOrganization();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToWaitlist = async () => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.redirectToWaitlist();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToTasks = async (opts) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.redirectToTasks(opts);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.handleRedirectCallback = async (params) => {
      ...
      const callback = () => {
        var _a222;
        return (_a222 = this.clerkjs) == null ? void 0 : _a222.handleRedirectCallback(params);
      };
      if (this.clerkjs && this.loaded) {
        void ((_a22 = callback()) == null ? void 0 : _a22.catch(() => {
        }));
      } else {
    ...
    this.handleGoogleOneTapCallback = async (signInOrUp, params) => {
      ...
      const callback = () => {
        var _a222;
        return (_a222 = this.clerkjs) == null ? void 0 : _a222.handleGoogleOneTapCallback(signInOrUp, params);
      };
      if (this.clerkjs && this.loaded) {
        void ((_a22 = callback()) == null ? void 0 : _a22.catch(() => {
        }));
    ...
    this.handleEmailLinkVerification = async (params) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.handleEmailLinkVerification(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithMetamask = async (params) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.authenticateWithMetamask(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithCoinbaseWallet = async (params) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.authenticateWithCoinbaseWallet(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithBase = async (params) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.authenticateWithBase(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithOKXWallet = async (params) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.authenticateWithOKXWallet(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithSolana = async (params) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.authenticateWithSolana(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithWeb3 = async (params) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.authenticateWithWeb3(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.createOrganization = async (params) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.createOrganization(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.getOrganization = async (organizationId) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.getOrganization(organizationId);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.joinWaitlist = async (params) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.joinWaitlist(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.signOut = async (...args) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.signOut(...args);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.__internal_attemptToEnableEnvironmentSetting = (options2) => {
      const callback = () => {
        var _a22;
        return (_a22 = this.clerkjs) == null ? void 0 : _a22.__internal_attemptToEnableEnvironmentSetting(options2);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
...
var useLoadedIsomorphicClerk = (mergedOptions) => {
  const optionsWithDefaults = React__default.useMemo(
    () => ({
  ...
  const isomorphicClerkRef = React__default.useRef(IsomorphicClerk.getOrCreateInstance(optionsWithDefaults));
  const [clerkStatus, setClerkStatus] = React__default.useState(isomorphicClerkRef.current.status);
  React__default.useEffect(() => {
...
if (globalThis.__clerkSharedModules) {
  ...
  if (existingVersion && existingVersion !== reactExports.version) {
    console.warn(
      `[@clerk/ui/register] React version mismatch detected. Already registered: ${existingVersion}, current import: ${reactExports.version}. This may cause issues with the shared @clerk/ui variant.`
    );
  }
} else {
...
export {
  ...
  SignIn as d,
  UserProfile as e,
  OrganizationList as f,
  useRoutingProps as u
};
