...
const createContextAndHook = (displayName, options) => {
  ...
  const Ctx = React__default.createContext(void 0);
  Ctx.displayName = displayName;
  const useCtx = () => {
    const ctx = React__default.useContext(Ctx);
...
function InitialStateProvider({ children, initialState }) {
  ...
  const initialStateCtx = React__default.useMemo(() => ({ value: initialStateSnapshot }), [initialStateSnapshot]);
  return /* @__PURE__ */ React__default.createElement(InitialStateContext.Provider, { value: initialStateCtx }, children);
}
function useInitialStateContext() {
  const initialState = _useInitialStateContext();
  if (initialState instanceof Promise) if ("use" in React__default && typeof React__default.use === "function") return React__default.use(initialState);
...
const __experimental_CheckoutProvider = ({ children, ...rest }) => {
  return /* @__PURE__ */ React__default.createElement(CheckoutContext.Provider, { value: { value: rest } }, children);
};
function useAssertWrappedByClerkProvider(displayNameOrFn) {
  if (!React__default.useContext(ClerkInstanceContext)) {
...
typeof window !== "undefined" ? React__default.useLayoutEffect : React__default.useEffect;
...
function ClerkContextProvider(props) {
  ...
  if (props.initialState instanceof Promise && !("use" in React__default && typeof React__default.use === "function")) throw new Error("initialState cannot be a promise if React version is less than 19");
  const clerkCtx = React__default.useMemo(() => ({ value: clerk }), [props.clerkStatus]);
  return /* @__PURE__ */ React__default.createElement(InitialStateProvider, { initialState: props.initialState }, /* @__PURE__ */ React__default.createElement(ClerkInstanceContext.Provider, { value: clerkCtx }, /* @__PURE__ */ React__default.createElement(__experimental_CheckoutProvider, { value: void 0 }, props.children)));
}
...
const useElementsOrCheckoutSdkContextWithUseCase = (useCaseString) => {
  return parseElementsContext(React__default.useContext(ElementsContext), useCaseString);
};
...
const createElementComponent = (type, isServer) => {
  ...
  const ClientElement = ({ id, className, fallback, options = {}, onBlur, onFocus, onReady, onChange, onEscape, onClick, onLoadError, onLoaderStart, onNetworksChange, onConfirm, onCancel, onShippingAddressChange, onShippingRateChange }) => {
    ...
    const domNode = React__default.useRef(null);
    ...
    return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, !isReady && fallback, /* @__PURE__ */ React__default.createElement("div", {
      id,
      style: {
...
const __vite_import_meta_env__ = { "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SSR": true, "TSS_DEV_SERVER": "false", "TSS_DEV_SSR_STYLES_BASEPATH": "/", "TSS_DEV_SSR_STYLES_ENABLED": "true", "TSS_INLINE_CSS_ENABLED": "false", "TSS_ROUTER_BASEPATH": "", "TSS_SERVER_FN_BASE": "/_serverFn/", "VITE_CLERK_PUBLISHABLE_KEY": "pk_test_Z2xvd2luZy10dXJ0bGUtNzkuY2xlcmsuYWNjb3VudHMuZGV2JA", "VITE_CLERK_SIGN_IN_FALLBACK_REDIRECT_URL": "/", "VITE_CLERK_SIGN_IN_URL": "/sign-in", "VITE_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL": "/", "VITE_CLERK_SIGN_UP_URL": "/sign-up" };
...
function parseVersion(version) {
  ...
  const [, majorStr, minorStr, patchStr] = match2;
  return {
...
async function loadScript(src = "", opts) {
  ...
  return retry(load, { shouldRetry: (_2, iterations) => {
    return iterations <= 5;
  } });
}
...
const versionSelector = (clerkJSVersion, packageVersion = "6.11.3") => {
...
const clerkUIScriptUrl = (opts) => {
  ...
  const version = versionSelector(__internal_clerkUIVersion, "1.12.1");
...
export {
  getCookieSuffix as A,
  isDevelopmentFromSecretKey as B,
  ClerkRuntimeError as C,
  match as D,
  getAutoProxyUrlFromEnvironment as E,
  isLegacyDevAccountPortalOrigin as F,
  isCurrentDevAccountPortalOrigin as G,
  buildAccountsBaseUrl as H,
  parsePublishableKey as I,
  getSuffixedCookieName as J,
  retry as K,
  isClerkAPIResponseError as L,
  parseError as M,
  isTruthy as N,
  isDevelopmentEnvironment as O,
  handleNetlifyCacheInDevInstance as P,
  apiUrlFromPublishableKey as Q,
  isProxyUrlRelative as R,
  isHttpOrHttps as S,
  TelemetryCollector as T,
  resolveKeysWithKeylessFallback as U,
  createKeylessService as V,
  createNodeFileStorage as W,
  __experimental_JWTPayloadToAuthObjectProperties as _,
  useClerkInstanceContext as a,
  buildErrorThrower as b,
  usePortalRoot as c,
  useInitialStateContext as d,
  eventMethodCalled as e,
  deriveState as f,
  getEnvVariable as g,
  inBrowser as h,
  isDeeplyEqual as i,
  createCheckAuthorization as j,
  deprecated as k,
  logErrorInDevMode as l,
  isVersionCompatible as m,
  ClerkContextProvider as n,
  createClerkEventBus as o,
  clerkEvents as p,
  handleValueOrFn as q,
  resolveAuthState as r,
  loadClerkJSScript as s,
  loadClerkUIScript as t,
  useAssertWrappedByClerkProvider as u,
  setClerkJSLoadingErrorPackageName as v,
  without as w,
  ClerkError as x,
  isomorphicAtob as y,
  ClerkAPIResponseError as z
};
